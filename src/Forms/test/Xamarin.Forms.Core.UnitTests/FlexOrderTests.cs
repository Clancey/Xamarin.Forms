...
namespace Xamarin.Forms.Core.UnitTests
{
	...
	public class FlexOrderTests : BaseTestFixture
	{
		...
		public void TestOrderingElements()
		{
			...
			Assert.That(label3.Bounds, Is.EqualTo(new RectangleF(0, 0, 912, 20)));
			Assert.That(label2.Bounds, Is.EqualTo(new RectangleF(0, 20, 912, 20)));
			Assert.That(label1.Bounds, Is.EqualTo(new RectangleF(0, 40, 912, 20)));
			Assert.That(label0.Bounds, Is.EqualTo(new RectangleF(0, 60, 912, 20)));
		}
	}
}
