...
namespace Xamarin.Forms.Core.UnitTests
{
	...
	public class RectUnitTests : BaseTestFixture
	{
		...
		public string TestRectToString(float x, float y, float w, float h)
		{
		...
		[Test]
		public void TestRectGetHashCode([Range(3, 4)] float x1, [Range(3, 4)] float y1, [Range(3, 4)] float w1, [Range(3, 4)] float h1,
