...
//			color = Color.FromHsla(.8f, .6f, .2f);
//			Assert.AreEqual(Color.FromHsla(.1f, .6f, .2f), color.WithHue(.1));
//			Assert.AreEqual(Color.FromHsla(.8f, .1f, .2f), color.WithSaturation(.1));
//			Assert.AreEqual(Color.FromHsla(.8f, .6f, .1f), color.WithLuminosity(.1));
//		}
