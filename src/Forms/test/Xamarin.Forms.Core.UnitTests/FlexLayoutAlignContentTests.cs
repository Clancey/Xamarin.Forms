...
namespace Xamarin.Forms.Core.UnitTests
{
	...
	public class FlexLayoutAlignContentTests : BaseTestFixture
	{
		...
		public void TestAlignContentFlexStart()
		{
			...
			layout.Layout(new RectangleF(0, 0, 130, 100));

			Assert.That(layout.Bounds, Is.EqualTo(new RectangleF(0, 0, 130, 100)));
			Assert.That(view0.Bounds, Is.EqualTo(new RectangleF(0, 0, 50, 10)));
			Assert.That(view1.Bounds, Is.EqualTo(new RectangleF(50, 0, 50, 10)));
			Assert.That(view2.Bounds, Is.EqualTo(new RectangleF(0, 10, 50, 10)));
			Assert.That(view3.Bounds, Is.EqualTo(new RectangleF(50, 10, 50, 10)));
			Assert.That(view4.Bounds, Is.EqualTo(new RectangleF(0, 20, 50, 10)));
		}
		...
		public void TestAlignContentFlexStartWithoutHeightOnChildren()
		{
			...
			Assert.That(view0.Bounds, Is.EqualTo(new RectangleF(0, 0, 50, 10)));
			Assert.That(view1.Bounds, Is.EqualTo(new RectangleF(0, 10, 50, 10)));
			Assert.That(view2.Bounds, Is.EqualTo(new RectangleF(0, 20, 50, 10)));
			Assert.That(view3.Bounds, Is.EqualTo(new RectangleF(0, 30, 50, 10)));
			Assert.That(view4.Bounds, Is.EqualTo(new RectangleF(0, 40, 50, 10)));
		}
		...
		public void TestAlignContentFlexStartWithFlex()
		{
			...
			layout.Layout(new RectangleF(0, 0, 100, 120));

			Assert.That(layout.Bounds, Is.EqualTo(new RectangleF(0, 0, 100, 120)));
			Assert.That(view0.Bounds, Is.EqualTo(new RectangleF(0, 0, 50, 40)));
			Assert.That(view1.Bounds, Is.EqualTo(new RectangleF(0, 40, 50, 40)));
			Assert.That(view2.Bounds, Is.EqualTo(new RectangleF(0, 80, 50, 0)));
			Assert.That(view3.Bounds, Is.EqualTo(new RectangleF(0, 80, 50, 40)));
			Assert.That(view4.Bounds, Is.EqualTo(new RectangleF(0, 120, 50, 0)));
		}
		...
		public void TestAlignContentFlexEnd()
		{
			...
			Assert.That(layout.Bounds, Is.EqualTo(new RectangleF(0, 0, 100, 100)));
			Assert.That(view0.Bounds, Is.EqualTo(new RectangleF(50, 0, 50, 10)));
			Assert.That(view1.Bounds, Is.EqualTo(new RectangleF(50, 10, 50, 10)));
			Assert.That(view2.Bounds, Is.EqualTo(new RectangleF(50, 20, 50, 10)));
			Assert.That(view3.Bounds, Is.EqualTo(new RectangleF(50, 30, 50, 10)));
			Assert.That(view4.Bounds, Is.EqualTo(new RectangleF(50, 40, 50, 10)));
		...
		public void TestAlignContentStretch()
		{
			...
			layout.Layout(new RectangleF(0, 0, 150, 100));
		...
		public void TestAlignContentSpaceBetween()
		{
			...
			Assert.That(view0.Bounds, Is.EqualTo(new RectangleF(0, 0, 50, 10)));
			Assert.That(view1.Bounds, Is.EqualTo(new RectangleF(50, 0, 50, 10)));
			Assert.That(view2.Bounds, Is.EqualTo(new RectangleF(0, 45, 50, 10)));
			Assert.That(view3.Bounds, Is.EqualTo(new RectangleF(50, 45, 50, 10)));
			Assert.That(view4.Bounds, Is.EqualTo(new RectangleF(0, 90, 50, 10)));
		}
		...
		public void TestAlignContentSpaceAround()
		{
			...
			layout.Layout(new RectangleF(0, 0, 140, 120));

			Assert.That(layout.Bounds, Is.EqualTo(new RectangleF(0, 0, 140, 120)));
			Assert.That(view0.Bounds, Is.EqualTo(new RectangleF(0, 15, 50, 10)));
			Assert.That(view1.Bounds, Is.EqualTo(new RectangleF(50, 15, 50, 10)));
			Assert.That(view2.Bounds, Is.EqualTo(new RectangleF(0, 55, 50, 10)));
			Assert.That(view3.Bounds, Is.EqualTo(new RectangleF(50, 55, 50, 10)));
			Assert.That(view4.Bounds, Is.EqualTo(new RectangleF(0, 95, 50, 10)));
		}
		...
		public void TestAlignContentStretchRowWithChildren()
		{
			...
			Assert.That(layout.Bounds, Is.EqualTo(new RectangleF(0, 0, 150, 100)));
		...
		public void TestAlignContentStretchRowWithFlex()
		{
			...
			Assert.That(layout.Bounds, Is.EqualTo(new RectangleF(0, 0, 150, 100)));
			Assert.That(view0.Bounds, Is.EqualTo(new RectangleF(0, 0, 50, 100)));
			Assert.That(view1.Bounds, Is.EqualTo(new RectangleF(50, 0, 0, 100)));
			Assert.That(view2.Bounds, Is.EqualTo(new RectangleF(50, 0, 50, 100)));
			Assert.That(view3.Bounds, Is.EqualTo(new RectangleF(100, 0, 0, 100)));
			Assert.That(view4.Bounds, Is.EqualTo(new RectangleF(100, 0, 50, 100)));
		}
		...
		public void TestAlignContentStretchRowWithMargin()
		{
			...
			Assert.That(layout.Bounds, Is.EqualTo(new RectangleF(0, 0, 150, 100)));
			Assert.That(view0.Bounds, Is.EqualTo(new RectangleF(0, 0, 50, 20)));
			Assert.That(view1.Bounds, Is.EqualTo(new RectangleF(60, 10, 50, 20)));
			Assert.That(view2.Bounds, Is.EqualTo(new RectangleF(0, 40, 50, 20)));
			Assert.That(view3.Bounds, Is.EqualTo(new RectangleF(60, 50, 50, 20)));
			Assert.That(view4.Bounds, Is.EqualTo(new RectangleF(0, 80, 50, 20)));
		}
