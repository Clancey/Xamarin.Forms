...
namespace Xamarin.Forms
{
	...
	public class ColorTypeConverter : TypeConverter
	{
		...
		static float ParseColorValue(string elem, int maxValue, bool acceptPercent)
		{
			elem = elem.Trim();
			...
			return float.Parse(elem, NumberStyles.Number, CultureInfo.InvariantCulture).Clamp(0, maxValue) / maxValue;
		}

		static float ParseOpacity(string elem)
		{
			return float.Parse(elem, NumberStyles.Number, CultureInfo.InvariantCulture).Clamp(0, 1);
		}
