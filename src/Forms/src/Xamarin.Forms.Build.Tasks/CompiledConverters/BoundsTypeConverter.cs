...
namespace Xamarin.Forms.Core.XamlC
{
	class BoundsTypeConverter : ICompiledTypeConverter
	{
		...
		IEnumerable<Instruction> GenerateIL(float x, float y, float w, float h, ModuleDefinition module)
		{
			...
			//			IL_0024:  newobj instance void valuetype Test.RectangleF::'.ctor'(float64, float64, float64, float64)
			...
			yield return Instruction.Create(OpCodes.Newobj, module.ImportCtorReference(("Xamarin.Platform", "Xamarin.Forms", "RectangleF"), parameterTypes: new[] {
