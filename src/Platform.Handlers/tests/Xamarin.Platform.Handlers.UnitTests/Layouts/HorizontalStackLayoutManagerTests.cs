...
namespace Xamarin.Platform.Handlers.UnitTests.Layouts
{
	...
	public class HorizontalStackLayoutManagerTests : StackLayoutManagerTests
	{
		...
		public void SpacingMeasurement(int viewCount, float viewWidth, int spacing, float expectedWidth)
		{
		...
		public void SpacingArrangementTwoItems(int spacing)
		{
			...
			var expectedRectangle1 = new RectangleF(100 + spacing, 0, 100, 100);
		...
		public void StackAppliesWidth(float viewWidth, float stackWidth, float expectedWidth)
		{
			var stack = CreateTestLayout();

			var view = CreateTestView(new SizeF(viewWidth, 100));
			...
			var manager = new HorizontalStackLayoutManager(stack);
			var measurement = manager.Measure(float.PositiveInfinity, 100);
		...
		public void ViewsArrangedWithDesiredHeights() 
		{
			...
			var view1 = CreateTestView(new SizeF(100, 200));
			var view2 = CreateTestView(new SizeF(100, 150));
			...
			var expectedRectangle1 = new RectangleF(0, 0, 100, 200);
			...
			var expectedRectangle2 = new RectangleF(100, 0, 100, 150);
