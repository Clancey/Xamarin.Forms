...
#pragma warning restore 0618
		...
		{
			var color = Element?.BackgroundColor ?? ColorExtensions.BackgroundColor.ToColor();
		...
		void UpdateBarTextColor()
		{
			...
			{
				ForegroundColor = barTextColor?.ToUIColor() ?? globalTitleTextAttributes?.ForegroundColor,
			...
			if (Forms.IsiOS11OrNewer)
			{
				...
				{
					ForegroundColor = barTextColor?.ToUIColor() ?? globalLargeTitleTextAttributes?.ForegroundColor,
